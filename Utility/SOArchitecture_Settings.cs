...
namespace ScriptableObjectArchitecture
{
    public class SOArchitecture_Settings : ScriptableObject
    {
        ...
        {
            get { return _defaultCreateAssetMenuOrder; }
            set { _defaultCreateAssetMenuOrder = value; }
        }

        [SerializeField]
        private string _codeGenerationTargetDirectory = "SO Architecture Data";
        ...
        [SerializeField]
        private int _defaultCreateAssetMenuOrder = 120;
    }
}